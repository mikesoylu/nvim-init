...
require("lazy").setup({
  ...
  -- opencode.nvim: AI-powered code assistant
  {
    ...
    -- stylua: ignore
    keys = {
      { '<leader>o', function() require('opencode').toggle() end, desc = 'Toggle embedded opencode', },
      { '<leader>o', function() require('opencode').ask('@selection: ') end, desc = 'Ask opencode about selection', mode = 'v', }
    },
  }
})
